            ...
            {(mode === 'Contain label') ?
                (<View style={[styles.switchContainer, { backgroundColor: value ? COLORS.PrimaryColor : '#D9D9D9', opacity: Disable && 0.8 }]}>
                    ...
                    <View style={{ flexDirection: 'row', alignContent: 'center' }}>
                        {mode === 'Left label' && <FText textAlign='center' textStyle='Label4'>{!value ? 'OFF' : 'On'} {Disable && ' - Disable'}</FText>}
                        ...
                        {mode === 'Right label' && <FText textAlign='center' textStyle='Label4'>{!value ? 'OFF' : 'On'} {Disable && ' - Disable'}</FText>}
