    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={{ width: '100%' }}>
                <View style={[styles.view, { flexDirection: 'row', marginVertical: 15 }]}>
                    <View style={{ marginHorizontal: 20, width: '20%' }}>
                    ...
                    <Text style={[commonStyles.text_20]}>Sửa thông tin cá nhân</Text>
                </View>
                            ...
                            <>
                                ...
                                <View style={{ width: '90%', marginVertical: 5 }}>
                                    <TextInput
                                        ...
                                        style={styles.view_input}
                                        onChangeText={text => setXa(text)}
                                        right={<TextInput.Icon icon={IconCleadr} onPress={() => { setFBottomSheerDate(!isFBottomSheetDate) }} />}
                                    />
                                </View>
                                ...
                                <FBottomSheet
                                    isVisible={isFBottomSheetDate}
                                    style={{ height: '65%' }}
                                    children={
                                        <View style={{ width: '100%', marginTop: 10 }}>
                                            <View style={{ paddingLeft: 25 }}>
                                                <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                                                    <TouchableOpacity style={{ width: '35%' }} onPress={() => { setFBottomSheerDate(!isFBottomSheetDate) }}>
                                                        <Out />
                                                    </TouchableOpacity>

                                                    <View style={{ width: '25%' }}>
                                                        <Text style={commonStyles.text_16}>Ngày sinh</Text>

                                                    </View>

                                                    <View style={{ width: '30%', marginHorizontal: 20 }}>
                                                        <Text style={[commonStyles.text_14, { textAlign: 'right', color: 'rgba(251, 175, 23, 1)' }]}>Xong</Text>
                                                    </View>
                                            ...
                                            <Calendar
                                                ...
                                                markedDates={{
                                                    [selected]: { selected: true, disableTouchEvent: true, selectedTextColor: 'white', selectedColor: 'rgba(251, 175, 23, 1)' }
                                                }}
                                            />


                                        </View>}
                                    closeModal={() => { setFBottomSheerDate(!isFBottomSheetDate) }}
                                />
                            </>
                        )}
                    </Formik>
