            ...
            {({
                ...
                <>
                    <SafeAreaView style={styles.container}>
                        ...
                        >
                            <TextItem styleName='text_16' fontWeight='700' color='black' >Sửa thông tin người nhận</TextItem>
                        </Header>
                        ...
                        <View style={{ width: '100%', height: '90%', position: 'relative' }}>
                            ...
                            <View style={[commonStyles.view_alignItem, { position: 'absolute', bottom: 0 }]}>
                                <TouchableOpacity style={[commonStyles.view_alignItem]} disabled={!isValid} >
                                    <CustomButton
